...
class TokenController {
	...
	function getAuthToken($code) {
			...
			$curl = curl_init();
			  ...
			  CURLOPT_POSTFIELDS => "grant_type=authorization_code&client_id=xxx&code=$code&redirect_uri=https%3A%2F%2Fintegrations.meldm.ml%2Fgcp%2FbigQuery%2Fpingid%2Fcallback.php",
