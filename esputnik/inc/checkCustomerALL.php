		...
		if (!isset($searchResult['return']['households']['contacts'][0]['communications']['detail']['value']))
									{
										...
										$cust_phoneNumber = $searchResult['return']['households']['contacts'][0]['communications']['detail']['value'];
									}
...
// commValue - phone
// custNumber - custNumber_id
// extIdValue - card number
/*
//$searchResult = checkCustomer('1200170322','custNumber');
//$searchResult = checkCustomer('96757','custNumber');
$searchResult = checkCustomer('93010231001138712','card');
$searchResult2 = checkCustomer('0672482300','phone');
//$searchResult = checkCustomer('93010231000224711','card');
*/
//$searchResult = checkCustomer('248563','id');
//$searchResult1 = checkCustomer('1200171094','id');
//$searchResult2 = checkCustomer('0672482290');
//$searchResult3 = checkCustomer('1200193243','id');
